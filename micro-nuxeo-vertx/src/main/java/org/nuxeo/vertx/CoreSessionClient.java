...
import org.nuxeo.vertx.impl.CoreSessionClientImpl;
...
public interface CoreSessionClient {
     ...
     * @return the client
     */
    static void create(Vertx vertx, String tenantId, JsonObject config, ClassLoader schemaClassLoader,
            Handler<AsyncResult<CoreSessionClient>> completionHandler) {
        vertx.executeBlocking(future -> {
            CoreSessionClient result = new CoreSessionClientImpl(vertx, tenantId, config, schemaClassLoader);
     ...
     * @return the client
     */
    static void create(Vertx vertx, String tenantId, ClassLoader schemaClassLoader,
            Handler<AsyncResult<CoreSessionClient>> completionHandler) {
        create(vertx, tenantId, new JsonObject(), schemaClassLoader, completionHandler);
    }
