...
public abstract class AbstractKeyValueStoreTest {
    ...
    abstract KeyValueService getKeyValueService();

    protected KeyValueStoreProvider store;

    @Before
    public void setUp() {
        store = (KeyValueStoreProvider) getKeyValueService().getKeyValueStore("default");
        store.clear();
    }
    ...
    public void testCopyDoesNotShareData() {
        KeyValueStore otherStore = getKeyValueService().getKeyValueStore("notregistered");
        String key = "mykey";
        store.put(key, "foo");
