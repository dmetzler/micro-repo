...
public class KeyValueServiceImpl implements KeyValueService {
    ...
    protected Map<String, KeyValueStoreDescriptor> descriptors = new ConcurrentHashMap<>();
    ...
    public void register(KeyValueStoreDescriptor descriptor) {
    ...
    public synchronized KeyValueStore getKeyValueStore(String name) {
        ...
        if (provider == null) {
            KeyValueStoreDescriptor descriptor = descriptors.get(name);
            if (descriptor == null) {
                // instantiate a copy of the default descriptor
                descriptor = descriptors.get(DEFAULT_STORE_ID);
                if (descriptor == null) {
