...
public class XSDLoader {
    ...
    private static final Logger log = LoggerFactory.getLogger(XSDLoader.class);
    ...
    protected static class NXSchemaResolver implements EntityResolver {
        ...
        public InputSource resolveEntity(String publicId, String systemId) throws IOException {
            ...
            if (!xsd.exists()) {
                ...
                URL url = Thread.currentThread().getContextClassLoader().getResource(importXSDSubPath);
    ...
    protected SimpleType loadSimpleType(Schema schema, XSType type, String fieldName) throws TypeBindingException {
        ...
        if (type instanceof RestrictionSimpleTypeImpl) {
            ...
            if (refName != null) {
                throw new TypeBindingException("refName", "Object resolver not supported");
