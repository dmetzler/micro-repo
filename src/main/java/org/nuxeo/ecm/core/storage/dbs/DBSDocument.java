...
public class DBSDocument extends BaseDocument<State> {
    ...
    public DBSDocument(DBSDocumentState docState, DocumentType type, DBSSession session, boolean readonly,
            SchemaManager sm, DocumentBlobManager dbm) {
        super(sm, dbm);
        ...
        if (docState != null && isProxy()) {
            proxySchemas = sm.getProxySchemas(type.getName());
        } else {
            proxySchemas = null;
        }
    ...
    protected boolean isSchemaForProxy(String schema) {
        return getSchemaManager().isProxySchema(schema, getType().getName());
    }
    ...
    public boolean removeFacet(String facet) {
        ...
        Set<String> otherSchemas = getSchemas(getType(), list, getSchemaManager());
    ...
    protected static Set<String> getSchemas(DocumentType type, List<Object> facets, SchemaManager schemaManager) {
