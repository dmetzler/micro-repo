...
public abstract class AbstractSession implements CoreSession, Serializable {
    ...
    public AbstractSession(CoreSessionServiceImpl coreSessionService) {
        ...
        this.schemaManager = coreSessionService.getSchemaManager();
    ...
    public DocumentType getDocumentType(String type) {
        return schemaManager.getDocumentType(type);
    }
    ...
    protected DocumentModel readModel(Document doc) {
        return DocumentModelFactory.createDocumentModel(doc, getSessionId(), null, schemaManager, css);
    }
    ...
    protected DocumentModel writeModel(Document doc, DocumentModel docModel) {
        return DocumentModelFactory.writeDocumentModel(docModel, doc, schemaManager, css);
    }
    ...
    private DocumentModel createDocumentModelFromTypeName(String typeName, Map<String, Serializable> options) {
        ...
        DocumentModel docModel = DocumentModelFactory.createDocumentModel(getSessionId(), docType, schemaManager, css);
        if (options == null) {
            options = new HashMap<>();
        }
    ...
    public DataModel getDataModel(DocumentRef docRef, Schema schema) {
        Document doc = resolveReference(docRef);
        checkPermission(doc, READ);
        return DocumentModelFactory.createDataModel(doc, schema, schemaManager);
    }
