...
public interface NuxeoPrincipal extends Principal, Serializable {
    ...
    /**
     * Property that defines if a transient username should be unique no matter what
     * base username is provided, or if a transient username should be always the
     * same for a given base username.
     *
     * @since 10.3
     */
     ...
     * <p>
     * Note: Some APIs that return principals from the database intentionally do not
     * fill this field
     *
     ...
     * <p>
     * This is the originating user (usually when this principal is a system user),
     * or if there is none this principal's user.
     *
     ...
     * <p>
     * If the configuration property {@value #TRANSIENT_USERNAME_UNIQUE_PROP} is
     * {@code true}, the transient username will be unique, otherwise it will always
     * be the same for a given {@code baseUsername}.
     *
     * @since 8.1
     */
    static String computeTransientUsername(String baseUsername, boolean unique) {
