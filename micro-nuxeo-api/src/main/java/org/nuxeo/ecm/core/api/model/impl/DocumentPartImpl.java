...
public class DocumentPartImpl extends ComplexProperty implements DocumentPart {
    ...
    public static class Builder {
        ...
        public Builder() {
            docPart = new DocumentPartImpl();
        }

        public Builder clearCompletePropertyBeforeSet(boolean clearCompletePropertyBeforeSet) {
            docPart.clearComplexPropertyBeforeSet = clearCompletePropertyBeforeSet;
            return this;
        }

        public Builder schema(Schema schema) {
            docPart.schema = schema;
            return this;
        }

        public DocumentPartImpl build() {
            if (docPart.schema == null) {
