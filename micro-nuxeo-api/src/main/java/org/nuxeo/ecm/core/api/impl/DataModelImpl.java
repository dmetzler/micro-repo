...
public class DataModelImpl implements DataModel {
     ...
     */
    public DataModelImpl(String schema, SchemaManager schemaManager) {
        this(schema, new HashMap<String, Object>(), schemaManager);
    }
     ...
     */
    public DataModelImpl(String schemaName, Map<String, Object> data, SchemaManager schemaManager) {
        assert data != null;
        Schema schema = schemaManager.getSchema(schemaName);
        dp = new DocumentPartImpl.Builder().schema(schema).build();
        if (!data.isEmpty()) {
