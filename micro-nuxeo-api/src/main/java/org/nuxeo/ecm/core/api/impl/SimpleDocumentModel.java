...
public class SimpleDocumentModel implements DocumentModel {
    ...
    public SimpleDocumentModel(SchemaManager schemaManager, List<String> schemas) {
        ...
        for (String schema : schemas) {
            ...
            DocumentPart part = new DocumentPartImpl.Builder().schema(s).build();
            dataModels.put(schema, new DataModelImpl(part));
            this.schemas.add(schema);
        }
    }

    public SimpleDocumentModel(SchemaManager schemaManager, String... schemas) {
    ...
    public Property getProperty(String xpath) throws PropertyException {
        ...
        String schemaName = DocumentModelImpl.getXPathSchemaName(cxpath, schemas, null, schemaManager);
        if (schemaName == null) {
            if (cxpath.indexOf(':') != -1) {
